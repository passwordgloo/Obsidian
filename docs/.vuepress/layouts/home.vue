...
<template>
  ...
  <div class="banner-container" :style="{ height: height + 'px' }" @mouseenter="mouseenterEvent"
    ...
    <span class="left-button" @click="switchBanner('left')"><img src="../public/images/left.webp" class="icon" /></span>
    <span class="right-button" @click="switchBanner('right')"><img src="../public/images/right.webp" class="icon" /></span>
